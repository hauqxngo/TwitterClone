...
class UserModelTestCase(TestCase):
    ...
    def test_valid_signup(self):
        test_user = User.signup('test', 'test@test.com', 'password', None)
        uid = 555
        test_user.id = uid
        db.session.commit()
    ...
    def test_invalid_password_signup(self):
        with self.assertRaises(ValueError) as context:
            User.signup("test", "test@test.com", "", None)
    ...
    def test_invalid_username(self):
        self.assertFalse(User.authenticate("abcxyz", "password"))

    def test_wrong_password(self):
        self.assertFalse(User.authenticate(self.u1.username, "123456789"))

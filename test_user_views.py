...
class MessageViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.u2 = User.signup("xyz", "test2@test.com", "password", None)
        self.u2_id = 456
        self.u2.id = self.u2_id
        self.u3 = User.signup("jqk", "test3@test.com", "password", None)
    ...
    def test_users_index(self):
        with self.client as c:
            ...
            self.assertIn("@jqk", str(res.data))
    ...
    def test_users_search(self):
        with self.client as c:
            ...
            self.assertNotIn("@jqk", str(res.data))
    ...
    def setup_likes(self):
        m1 = Message(text="oh testing", user_id=self.testuser_id)
        m2 = Message(text="drinking water", user_id=self.testuser_id)
        m3 = Message(id=7412, text="buying groceries", user_id=self.u1_id)
        db.session.add_all([m1, m2, m3])
        db.session.commit()

        l1 = Likes(user_id=self.testuser_id, message_id=7412)
    ...
    def test_add_like(self):
        m = Message(id=1984, text="Today is Sunday", user_id=self.u1_id)
        db.session.add(m)
        db.session.commit()
        ...
        with self.client as c:
            ...
            res = c.post("/messages/1984/like", follow_redirects=True)
